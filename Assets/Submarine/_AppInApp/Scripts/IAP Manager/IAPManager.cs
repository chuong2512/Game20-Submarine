...
public class IAPKey
{
    public const string PACK1 = "pack1_submarine";
    public const string PACK2 = "pack2_submarine";
    public const string PACK3 = "pack3_submarine";
    public const string PACK4 = "pack4_submarine";
}
